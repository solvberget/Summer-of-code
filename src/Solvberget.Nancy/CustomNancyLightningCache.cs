...
namespace Solvberget.Nancy
{
    ...
    /// 
    /// This version is a modified version of
    /// https://github.com/creamdog/Nancy.LightningCache/blob/4d10ad8a0b487a5d7ffc51b97c8a2f4850270544/Nancy.LightningCache/LightningCache.cs
    /// with a couple of added null checks in InvokePreRequirements()
    /// </summary>
    public class CustomNancyLightningCache
    {
        ...
        private static Response InvokePreRequirements(NancyContext context)
        {
            ...
            if (resolution != null && resolution.Before != null)
            {
